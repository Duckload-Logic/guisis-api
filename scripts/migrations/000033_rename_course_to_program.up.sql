...
RENAME TABLE courses TO programs;

-- Rename course_name column in programs
ALTER TABLE programs RENAME COLUMN course_name TO program_name;

-- Rename indexes in programs
ALTER TABLE programs RENAME INDEX unique_idx_course_code TO unique_idx_program_code;
ALTER TABLE programs RENAME INDEX unique_idx_course_name TO unique_idx_program_name;

-- Rename course_id column in student_personal_info
ALTER TABLE student_personal_info RENAME COLUMN course_id TO program_id;

-- Rename index on student_personal_info
ALTER TABLE student_personal_info RENAME INDEX idx_student_personal_info_course_id TO idx_student_personal_info_program_id;

-- Rename columns in student_cors
ALTER TABLE student_cors RENAME COLUMN course_desc TO program_desc;
ALTER TABLE student_cors RENAME COLUMN course_code TO program_code;
